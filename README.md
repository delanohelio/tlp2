...
| 14     | [25/08 e 26/08](conteudos/semana-14.md) | **Comunicação entre Componentes (Filho para Pai)**<br/>- Eventos Customizados com `$emit`.                                                            | **Catálogo de Filmes (Parte 2):** Adicionar um botão "Favoritar" no `FilmeCard`. Ao clicar, o card (filho) emite um evento para a lista (pai) para adicionar o filme a uma lista de favoritos. |
